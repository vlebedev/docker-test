...
METEOR_CONTAINER_1=$(sudo docker run -d -p 3000 -e PORT=3000 -e MONGO_URL=mongodb://$MONGODB_HOST:$MONGODB_PORT test/meteor)
METEOR_PORT_1=$(sudo docker port $METEOR_CONTAINER_1 3000)
METEOR_HOST_1=$BRIDGE_IP

METEOR_CONTAINER_2=$(sudo docker run -d -p 3001 -e PORT=3001 -e MONGO_URL=mongodb://$MONGODB_HOST:$MONGODB_PORT test/meteor)
